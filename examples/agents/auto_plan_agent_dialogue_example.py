"""Agents: auto reasoning_engine agents example?
...
Examples:
    ...
    run example.
    ..code-block:: shell
        uv run examples/agents/auto_plan_agent_dialogue_example.py
"""
...
async def main():
    ...
    context: AgentContext = AgentContext(
        conv_id="test456", gpts_app_name="代码分析助手", max_new_tokens=2048,conv_session_id="123321",temperature=0.01,
    )
