...
// import { CodePreview } from '@example/uni-chat';
...
```json
{
  "name": "@example/uni-chat",
  "version": "1.1.92",
  "description": "A library project powered by fatherrary",
  "repository": {
    "type": "git",
    "url": "https://code.example.com/tr-web/UniChat"
  },
  "author": "derisk",
  ...
  "scripts": {
    ...
    "ci": "npm run lint && jest --coverage --passWithNoTests npm run lint && jest --coverage --passWithNoTests npm run lint && jest --coverage --passWithNoTests npm run lint && jest --coverage --passWithNoTests npm run lint && jest --coverage --passWithNoTests npm run lint && jest --coverage --passWithNoTests",
    "cov": "jest --coverage",
    "create": "father create",
    "deploy": "father deploy",
    "dev": "father doc dev",
    "doctor": "father doctor",
    "lint": "father lint",
    "prepare": "father setup && husky install",
    "prepublishOnly": "father prepublish",
    "pull": "father pull",
    "start": "sudo PORT=443 HTTPS=true npm run dev",
    "test": "jest"
  },
  "commitlint": {
    "extends": [
  ...
  "lint-staged": {
    ...
    "*.{js,jsx}": [
      "father lint --fix --eslint-only",
      "prettier --cache --write"
    ],
    "*.{css,less}": [
      "father lint --fix --stylelint-only",
      "prettier --cache --write"
    ],
    "*.{ts,tsx}": [
      "father lint --fix --eslint-only",
  ...
  "dependencies": {
    "@example/sregpt-ui": "^1.0.16",
    "@example/tech-ui": "^3.14.5",
    "@example/vis-datafun": "^1.0.0",
