...
from derisk.configs import DOMAIN_TYPE_FINANCIAL_REPORT
from derisk.configs.model_config import EMBEDDING_MODEL_CONFIG
...
from derisk_ext.rag.assembler.summary import SummaryAssembler
...
class KnowledgeService:
    ...
    def create_knowledge_space(self, request: KnowledgeSpaceRequest):
        ...
        if request.storage_type == "VectorStore":
            request.storage_type = self.rag_config.storage.vector.get_type_value()
    ...
    def update_knowledge_space(
        ...
        entity = KnowledgeSpaceEntity(
            ...
            storage_type=space_request.storage_type,
    ...
    def _build_default_context(self):
        from derisk_app.scene.chat_knowledge.v1.prompt import (
            _DEFAULT_TEMPLATE,
            PROMPT_SCENE_DEFINE,
        )
    ...
    async def _llm_extract_summary(
        ...
        """
        from derisk_app.scene import ChatParam, ChatScene
        ...
        from derisk_app.openapi.api_v1.api_v1 import CHAT_FACTORY
