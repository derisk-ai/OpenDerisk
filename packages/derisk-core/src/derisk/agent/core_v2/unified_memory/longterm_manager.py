...
class LongTermMemoryManager:
    ...
    def __init__(
        ...
        Args:
            ...
            processors: Dict mapping memory_id to MemoryProcessor (NEW)
            strategies: Dict mapping memory_id to MemorySpaceStrategy (NEW)
            recall_tracker: RecallTracker instance (NEW)
            hybrid_search_engine: HybridSearchEngine instance (NEW)
        """
        self._config = config
...
# ------------------------------------------------------------------
# MemoryIntegrationBundle — full v2 memory stack
# ------------------------------------------------------------------
...
class MemoryIntegrationBundle:
    ...
    Bundles together all v2 memory components:
...
async def create_memory_integration_bundle(
    ...
    This is the single entry point for building the full v2 memory stack.
    It creates all components and wires them together.
