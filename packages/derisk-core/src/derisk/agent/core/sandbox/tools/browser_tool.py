...
async def browser_navigate(
    ...
    try:
        ...
        res = await client.browser.browser_navigate(url, need_screenshot=True)
        return _parse_browser_response(res, "browser_navigate")
...
async def click_element(
    ...
    try:
        ...
        return _parse_browser_response(
            res,
            "click_element",
            {
                "index": index
...
async def input_text(
    ...
    try:
        ...
        return _parse_browser_response(res, "input_text")
    except Exception as exc:
...
async def get_dropdown_options(
    ...
    try:
        ...
        return _parse_browser_response(res, "get_dropdown_options")
    except Exception as exc:
...
async def select_dropdown_option(
    ...
    try:
        ...
        return _parse_browser_response(res, "select_dropdown_option")
    except Exception as exc:
...
async def browser_mouse_wheel(
    ...
    try:
        logger.info(f"browser_mouse_wheel y, {y}")
        res = await client.browser.browser_mouse_wheel(
            y=y,
            need_screenshot=True,
        )
        return _parse_browser_response(res, "browser_mouse_wheel")
    except Exception as exc:
...
async def page_content(
    ...
    try:
        ...
        return _parse_browser_response(res, "page_content")
    except Exception as exc:
...
async def browser_mouse_move(
    ...
    try:
        ...
        return _parse_browser_response(res, "browser_mouse_move")
    except Exception as exc:
...
async def browser_open_tab(
    ...
    try:
        ...
        return _parse_browser_response(res, "browser_open_tab")
    except Exception as exc:
