...
from derisk.core.awel.util.parameter_util import (
    BaseDynamicOptions,
    OptionValue,
    RefreshOptionRequest,
)
from derisk.core.interface.serialization import Serializable
from derisk.util.executor_utils import DefaultExecutorFactory, blocking_func_to_async
from derisk.util.i18n_utils import LazyTranslatedString
...
class BaseMetadata(BaseResource):
    ...
    documentation_url: Optional[str] = Field(
        ...
        examples=["https://docs.derisk.site/docs/awel"],
    )
...
def auto_register_resource(
    ...
    **decorator_kwargs,
    ...
    from derisk.util.function_utils import TYPE_STRING_TO_TYPE
...
class ViewMetadata(BaseMetadata):
    ...
    type_cls: Optional[str] = Field(
        ...
        examples=["derisk.model.operators.LLMOperator"],
    )
