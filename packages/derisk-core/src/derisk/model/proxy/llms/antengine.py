...
_DEFAULT_API_BASE = "https://zdfmng.example.com/chat/completions"
...
@auto_register_resource(
    ...
    documentation_url="https://yuque.com/ntzgfe/kg7h1z/cx0cb0m2w3rui5k8#hJFXC",
    show_in_ui=False,
)
@dataclass
...
register_proxy_model_adapter(
    ...
    supported_models=[
        ModelMetadata(
            ...
            link="https://yuque.com/ntzgfe/kg7h1z/cx0cb0m2w3rui5k8#hJFXC",
