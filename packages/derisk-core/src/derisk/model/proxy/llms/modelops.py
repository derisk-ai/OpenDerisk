...
_DEFAULT_API_BASE = "https://codebot.example.com/v1/chat/completions"
...
@auto_register_resource(
    ...
    documentation_url="https://yuque.com/stw5mf/kg7h1z/bg6hekmdev2ppenm",
    show_in_ui=False,
)
@dataclass
...
register_proxy_model_adapter(
    ...
    supported_models=[
        ModelMetadata(
            ...
            link="https://yuque.com/stw5mf/kg7h1z/bg6hekmdev2ppenm",
