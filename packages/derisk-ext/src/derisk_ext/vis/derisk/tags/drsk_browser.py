...
class DrskBrowserContent(DrskVisBase):
    ...
    title_avatar: Optional[str] = Field(
        default="https://nexa-api-pre.example.com/api/oss/getFileByFileName?fileName=03c48108-d336-4a8a-920d-a820d5e51c57.png",
        description="浏览器title",
    )
    ...
    avatar: str = Field(
        ...
        default="https://nexa-api-pre.example.com/api/oss/getFileByFileName?fileName=1bce9d06-703c-4ce3-8330-d3b11acd1aa7.png",
        description="avatar",
    )
