"""Risk Dashboard serve component.

This module provides the main serve component for the risk dashboard service,
...
class Serve(BaseServe):
    """Risk Dashboard serve component for Derisk.

    This component provides risk dashboard capabilities:
    - Entity type and entity management
    - Risk check execution and history
    - User subscriptions
    - Risk summary and heatmap data
    """
    ...
    def __init__(
        ...
        """Initialize the risk dashboard serve component.
    ...
    def on_init(self):
        ...
        Load the database models to ensure table creation.
        """
    ...
    def before_start(self):
        ...
        logger.info("Starting risk dashboard serve component")

    def before_stop(self):
        """Called before the application stops."""
        logger.info("Stopping risk dashboard serve component")