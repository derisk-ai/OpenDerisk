...
from derisk.core.awel import IteratorTrigger, JoinOperator, MapOperator
...
class AgentEvaluator(Evaluator):
    ...
    Examples:
        .. code-block:: python
            ...
            import os
            import asyncio
            from derisk.rag.operators import (
                EmbeddingRetrieverOperator,
                RetrieverEvaluatorOperator,
            )
            from derisk.rag.evaluation import (
                RetrieverEvaluator,
    ...
    async def evaluate(
        ...
        **kwargs,
        ...
        from derisk.core.awel import DAG, MapOperator
